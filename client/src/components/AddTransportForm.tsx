...
import {addTransportFetch} from '../redux-data/transport';
...
const AddTransportForm = (props: any) => {
  ...
  const handleSubmit = (e: any) => {
    ...
    props.form.validateFields((err: any, values: any) => {
      if (!err) {
        values.status = 'way';
        values.devices = values.devices.split(',').map((item: any) => ({number: item, damaged: false}))
